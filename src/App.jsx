    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-950 px-4">
      <div className="w-full max-w-sm text-center space-y-1">
        <img
          src="/logo.png"
          alt=""
          className="w-40 h-40 rounded-full mb-3 mx-auto border-4 border-slate-800 shadow-lg object-cover"
        />
        ...
        <div className="space-y-3">
          {links.map((link, idx) => (
            <a
              ...
              className={`block w-full py-3 rounded-xl font-semibold transition ${link.bg} flex justify-between items-center px-5`}
            >
              <span className='flex'>
                {link.icon}
              </span>
